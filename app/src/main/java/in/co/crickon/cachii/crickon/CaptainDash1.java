...
public class CaptainDash1 extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SQLiteHandler repo=new SQLiteHandler(CaptainDash1.this);
...
/*View view=navigationView.inflateHeaderView(R.layout.nav_header_main);*/
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_player_request) {
            ...
            Intent intent=new Intent(CaptainDash1.this,CheckRequest.class);
            intent.putExtra(TAG_CAPTAINID, captainId);
            startActivity(intent);
            finish();
        } else if (id == R.id.nav_my_profile) {
            Intent intent=new Intent(CaptainDash1.this,Profiles.class);
            startActivity(intent);
            finish();
        } else if (id == R.id.nav_matches) {
            Intent intent=new Intent(CaptainDash1.this,Matches.class);
            startActivity(intent);
            finish();
        } else if (id == R.id.nav_sign_out) {
            SessionManager session = new SessionManager(CaptainDash1.this);
            session.setLogin(false);
            SQLiteHandler repo=new SQLiteHandler(getApplicationContext());
            repo.deleteUsers();
            Intent intent=new Intent(CaptainDash1.this,Login.class);
            startActivity(intent);
            finish();
        } else if (id == R.id.nav_match_request) {
            Intent intent=new Intent(CaptainDash1.this,MatchRequests.class);
            startActivity(intent);
            finish();
        }  else if (id == R.id.nav_about_us) {
            Intent intent=new Intent(CaptainDash1.this,Aboutuss.class);
            startActivity(intent);
            finish();
        } else if (id == R.id.nav_feedback) {
            Intent intent=new Intent(CaptainDash1.this,Feedback.class);
            startActivity(intent);
            finish();
        } else if (id == R.id.nav_leaderboard) {
            Intent intent=new Intent(CaptainDash1.this,Leaderboard.class);
            startActivity(intent);
            finish();
        }
