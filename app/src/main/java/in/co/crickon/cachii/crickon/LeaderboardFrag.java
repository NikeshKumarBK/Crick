...
public class LeaderboardFrag extends SwipeDownToRefresh {
    ...
    private static String url_leaderboard = "http://crickon.co.in/php/Leaderboard.php";
    ...
    String pincode,teamid,team,playerId;
    int flag=0;

    private static final String LOG_TAG = LeaderboardFrag.class.getSimpleName();
