...
public class LiveMatches extends ListActivity {
    // Progress Dialog
    ...
    SQLiteHandler repo=new SQLiteHandler(LiveMatches.this);
    String teamid,teamname,date;
...
*/
    ...
    class RequestResponse extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(LiveMatches.this);
    ...
    class LoadAllPlayerRequest extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String file_url) {
            ...
            if(flag==1)
            {
                Toast.makeText(LiveMatches.this,"No Player request!!",Toast.LENGTH_SHORT).show();
            }
            pDialog.dismiss();
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    ...
                    ListAdapter adapter1 = new SimpleAdapter(
                            LiveMatches.this, playerRequest,
                            R.layout.single_row_live_match, new String[] { TAG_TEAMID,TAG_OPPONENTID,TAG_OPPONENTNAME,
                            TAG_TEAMNAME},
                            new int[]{R.id.teamid, R.id.teamname,R.id.oppid,R.id.oppname});
                    // updating listview
    ...
    public void onBackPressed() {
        Intent intent=new Intent(LiveMatches.this,Login.class);
